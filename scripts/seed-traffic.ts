/**
 * Fire N requests at the running agent so SigNoz has enough signal for the
 * drift detector. Mix of prompts biased toward one skill early, another
 * later, so the drift verdict has something real to catch.
 *
 * Usage:
