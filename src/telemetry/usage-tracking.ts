 ...
 * both in span attributes (for SigNoz trace correlation) and directly in API
 * responses (so token spend and provider/model are visible without opening
 * SigNoz at all).
 */
import type { LanguageModelUsage } from 'ai';
import type { Span } from '@opentelemetry/api';
import type { ModelClientDescriptor } from '../agent/model-client.js';
 ...
 * operator can search SigNoz traces by task id and see exactly which model
 * call and how many tokens a given task cost.
 */
