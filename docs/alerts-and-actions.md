...
See [deployment.md](./deployment.md#shared-state-with-redis).
...
[security.md](./security.md#integration-webhook-authentication).
...
[operator console](./console.md) and via the control-plane API
...
[SigNoz MCP](./signoz.md#ask-your-agents-telemetry-in-plain-english-signoz-mcp))
...
> This is a pragmatic heuristic: the current window still blends pre- and
> post-switch data, and the judge reasons about the mix. Rigorous
> re-baselining (measuring drift only from post-switch data forward) is a
> planned follow-up.

## Configuration reference

Full env var tables for the loop and channels are in
[configuration.md](./configuration.md#autopilot--serverconfig-loop-2).
